...
describe 'Administrador cadastra uma configuração de distância' do 
  it 'a partir do menu' do 
    ...
    click_on('Nova Configuração de Distância')
  ...
  it 'com sucesso' do 
    ...
    #assert
    expect(page).to have_content('Configuração de distância cadastrado com sucesso')
  end 
  ...
  it 'com dados incompletos' do 
    ...
    #assert 
    expect(page).to have_content 'Configuração de distância não cadastrado'
